...
class MagicLessonList(Toplevel):
    def __init__(self,parent,*args, **kwargs):
        ...
        s = ttk.Style(self)
        s.theme_use('clam')
        s.configure('EditRed.TLabelframe', background="gray27")
        s.configure('EditRed.TLabelframe.Label', font=('helvetica', 14, 'bold'))
        s.configure('EditRed.TLabelframe.Label', foreground="white")
        s.configure('EditRed.TLabelframe.Label', background="gray27")
        ...
        s.configure('Edit.Vertical.TScrollbar', background="gray27", foreground="gray33")
        s.map('Edit.Vertical.TScrollbar', background=[('active', '!disabled', 'gray33'), ('pressed', 'gray27')],
        ...
        self.choice_list = tk.Listbox(self.scroll_frame, selectmode=tk.SINGLE, background="white",width=35,height=30,
        ...
        self.scrollbar = ttk.Scrollbar(self.scroll_frame, style='Edit.Vertical.TScrollbar')
